...
public class LeetCode94 {
    public static void main(String[] args) {
        ...
        List<Integer> numbers1 = new Solution().inorderTraversal(tree1);
        System.out.println(numbers1);
        System.out.println("================================================");

        var tree2 = new TreeNode(1);
        List<Integer> numbers2 = new Solution().inorderTraversal(tree2);
        System.out.println(numbers2);
        System.out.println("================================================");

        var tree3 = new TreeNode();
        List<Integer> numbers3 = new Solution().inorderTraversal(tree3);
